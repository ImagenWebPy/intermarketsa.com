...
<div class="sec-item flex-w">
    ...
    <div class="of-hidden size-w-2 respon2">
        <div class="hov-img1 pos-relative">
            <img src="<?= URL; ?>public/images/bg-item-02.jpg" alt="IMG">

            <a href="shop-product-grid.html" class="s-full ab-t-l flex-col-c-m bg11 p-all-15 hov1-parent">
                <div class="wrap-pic-max-w">
                    <img src="<?= URL; ?>public/images/icons/symbol-04.png" alt="IMG">
                </div>
    ...
    <div class="of-hidden size-w-2 respon2">
        <div class="hov-img1 pos-relative">
            <img src="<?= URL; ?>public/images/bg-item-03.jpg" alt="IMG">

            <a href="shop-product-grid.html" class="s-full ab-t-l flex-col-c-m bg11 p-all-15 hov1-parent">
                <div class="wrap-pic-max-w">
                    <img src="<?= URL; ?>public/images/icons/symbol-05.png" alt="IMG">
                </div>
    ...
    <div class="of-hidden size-w-2 respon2">
        <div class="hov-img1 pos-relative">
            <img src="<?= URL; ?>public/images/bg-item-04.jpg" alt="IMG">

            <a href="shop-product-grid.html" class="s-full ab-t-l flex-col-c-m bg11 p-all-15 hov1-parent">
                <div class="wrap-pic-max-w">
                    <img src="<?= URL; ?>public/images/icons/symbol-06.png" alt="IMG">
                </div>
...
<section class="sec-deal bg-img1" style="background-image: url('images/bg-01.jpg');">
    <div class="flex-w flex-m how-pos2-parent">
        <img class="how-pos2 respon4 dis-none-xl" src="<?= URL; ?>public/images/other-03.png" alt="IMG">

        <div class="size-w-3 txt-center wrap-pic-max-s w-full-lg">
            <img src="<?= URL; ?>public/images/other-02.png" alt="IMG">
        </div>
                    ...
                    <div class="wrap-slick2">
                        ...
                        <div class="slick2">
                            <div class="item-slick2 p-all-15">
                                ...
                                <a href="product-single.html" class="flex-w flex-str size-h-1 bo-all-1 bocl12 hov3 trans-04 m-b-30">
                                    <div class="size-w-6 flex-c-m wrap-pic-max-s">
                                        <img src="<?= URL; ?>public/images/product-17.jpg" alt="IMG-PRODUCT">
                                    </div>
...
<div class="sec-testimonials bg12 p-t-120 p-b-80 how-pos3-parent how-pos4-parent">
    <img class="how-pos3 dis-none-xl" src="<?= URL; ?>public/images/other-04.png" alt="IMG">
    <img class="how-pos4 dis-none-xl" src="<?= URL; ?>public/images/other-05.png" alt="IMG">
        ...
        <div class="row">
            <div class="col-md-6 p-b-50">
                <div class="p-r-15 p-r-0-lg">
                    <a href="blog-single.html" class="wrap-pic-w hov4">
                        <img src="<?= URL; ?>public/images/blog-01.jpg" alt="BLOG">
                    </a>
            ...
            <div class="col-md-6 p-b-50">
                <div class="p-l-15 p-l-0-lg">
                    <a href="blog-single.html" class="wrap-pic-w hov4">
                        <img src="<?= URL; ?>public/images/blog-02.jpg" alt="BLOG">
                    </a>
    ...
    <div class="container">
        <div class="flex-w flex-sa-m bo-t-1 bocl13 p-tb-60">
            <a href="#" class="dis-block how2 p-rl-15 m-tb-20">
                <img class="trans-04" src="<?= URL; ?>public/images/icons/symbol-07.png" alt="IMG">
            </a>

            <a href="#" class="dis-block how2 p-rl-15 m-tb-20">
                <img class="trans-04" src="<?= URL; ?>public/images/icons/symbol-08.png" alt="IMG">
            </a>

            <a href="#" class="dis-block how2 p-rl-15 m-tb-20">
                <img class="trans-04" src="<?= URL; ?>public/images/icons/symbol-09.png" alt="IMG">
            </a>

            <a href="#" class="dis-block how2 p-rl-15 m-tb-20">
                <img class="trans-04" src="<?= URL; ?>public/images/icons/symbol-10.png" alt="IMG">
            </a>

            <a href="#" class="dis-block how2 p-rl-15 m-tb-20">
                <img class="trans-04" src="<?= URL; ?>public/images/icons/symbol-11.png" alt="IMG">
            </a>
        </div>
    </div>
</div>
