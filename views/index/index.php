        ...
        <div id="rev_slider_1" class="rev_slide fullwidthabanner" data-version="5.4.5" style="display:none">
            <ul>
                ...
                <li data-transition="fade">
                    <!--  -->
                    <img src="<?= URL; ?>public/images/slider-chia.jpg" alt="IMG-BG" class="rev-slidebg">
                    ...
                    <div class="tp-caption tp-resizeme layer1" 
                         ...
                         >
                        <span class="child1">Lorem</span> <span class="child2">Ipsum</span>
                    </div>

                    <!--  -->
                    <h2 class="tp-caption tp-resizeme layer2" 
                        data-frames='[{"delay":500,"speed":1500,"frame":"0","from":"x:[155%];y:0px;z:0;rX:0;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;opacity:1;","mask":"x:[-100%];y:0;s:inherit;e:inherit;","to":"o:1;","ease":"Power3.easeOut"},{"delay":"wait","speed":300,"frame":"999","to":"auto:auto;","ease":"Power3.easeInOut"}]'
                ...
                <li data-transition="fade">
                    <!--  -->
                    <img src="<?= URL; ?>public/images/slider-sesamo.jpg" alt="IMG-BG" class="rev-slidebg">
                ...
                <li data-transition="fade">
                    <!--  -->
                    <img src="<?= URL; ?>public/images/slider-mani.jpg" alt="IMG-BG" class="rev-slidebg">
...
<section class="sec-welcome bg0 p-t-145 p-b-95">
    <div class="container">
        ...
        <div class="wrap-pic-max-w flex-c-t flex-w p-t-255 item-welcome-parent">
            <img class="size-w-1" src="<?= URL; ?>public/images/index-768-564.png" alt="IMG">
...
<div class="sec-item flex-w">
    ...
    <div class="of-hidden size-w-2 respon2">
        <div class="hov-img1 pos-relative">
            <img src="<?= URL; ?>public/images/img-1.jpg" alt="IMG">
    ...
    <div class="of-hidden size-w-2 respon2">
        <div class="hov-img1 pos-relative">
            <img src="<?= URL; ?>public/images/img-2.jpg" alt="IMG">
    ...
    <div class="of-hidden size-w-2 respon2">
        <div class="hov-img1 pos-relative">
            <img src="<?= URL; ?>public/images/img-3.jpg" alt="IMG">
            <a href="#" class="s-full ab-t-l flex-col-c-m bg11 p-all-15 hov1-parent">
                <span class="txt-l-102 cl0 txt-center p-t-30 p-b-13">
                    Lorem Ipsum
                </span>
    ...
    <div class="of-hidden size-w-2 respon2">
        <div class="hov-img1 pos-relative">
            <img src="<?= URL; ?>public/images/img-4.jpg" alt="IMG">
            <a href="#" class="s-full ab-t-l flex-col-c-m bg11 p-all-15 hov1-parent">
                <span class="txt-l-102 cl0 txt-center p-t-30 p-b-13">
                    Lorem Ipsum
                </span>
...
<div class="sec-testimonials bg12 p-t-120 p-b-80 how-pos3-parent how-pos4-parent">
    <img class="how-pos3 dis-none-xl" src="<?= URL; ?>public/images/img-bottom-chia.png" alt="IMG">
    <img class="how-pos4 dis-none-xl" src="<?= URL; ?>public/images/img-top-sesamo.png" alt="IMG">
                    ...
                    <div class="flex-col-c-m">
                        <div class="layer-slick3 animated visible-false" data-appear="zoomIn" data-delay="100">
                            <div class="wrap-pic-s size-a-3 bo-3-rad-50per bocl10 of-hidden">
                                <img src="<?= URL; ?>public/images/responsabilidad.jpg" alt="AVATAR">
                            </div>
                        </div>
                        ...
                        <div class="layer-slick3 animated visible-false" data-appear="fadeInUp" data-delay="1600">
                            <p class="txt-center txt-s-104 cl6 size-w-8">
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc sollicitudin nisl vel lacus dictum, vitae convallis nunc dignissim. Morbi sodales lorem purus, sit amet vestibulum ipsum aliquet id. Duis euismod mi dolor, ac suscipit nunc consequat ut. Pellentesque laoreet faucibus justo, at consectetur felis laoreet nec. Vestibulum faucibus nibh ut sagittis placerat. Nullam non felis vel mauris semper dignissim. Ut fermentum congue mauris sed pellentesque. Integer convallis orci sed semper posuere. Nam eget dictum arcu. Aliquam vel magna varius, euismod ligula ac, interdum risus. Duis tempor, elit eget rutrum maximus, neque nibh iaculis eros, a efficitur dui nulla eget quam. Cras justo massa, euismod nec scelerisque in, auctor a velit. Aliquam erat volutpat. Donec sed vulputate nibh, sed tempus massa. Sed pellentesque maximus nisi, non sagittis risus consequat a. Aliquam ut erat posuere, molestie nibh fringilla, porta lorem.
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-md-6 p-b-50">
                <div class="p-r-15 p-r-0-lg">
                    <a href="#" class="wrap-pic-w hov4">
                        <img src="<?= URL; ?>public/images/blog-1.jpg" alt="BLOG">
                    </a>
                    ...
                    <div class="flex-w p-t-30">
                        ...
                        <div class="size-w-9">
                            <h4 class="p-b-13">
                                <a href="#" class="txt-m-109 cl3 hov-cl10 trans-04">
                            ...
                            <div class="how-line2 p-l-40">
                                <a href="#" class="txt-s-105 cl9 hov-cl10 trans-04">
                                    Leer Más
                                </a>
                            </div>
                        </div>
            ...
            <div class="col-md-6 p-b-50">
                <div class="p-l-15 p-l-0-lg">
                    <a href="#" class="wrap-pic-w hov4">
                        <img src="<?= URL; ?>public/images/blog-2.jpg" alt="BLOG">
                    </a>
    ...
    <div class="container">
        <div class="flex-w flex-sa-m bo-t-1 bocl13 p-tb-60">
            <a href="#" class="dis-block how2 p-rl-15 m-tb-20">
                <img class="trans-04" src="<?= URL; ?>public/images/certificacion-1.png" alt="IMG" style="width: 90px;">
            </a>
            <a href="#" class="dis-block how2 p-rl-15 m-tb-20">
                <img class="trans-04" src="<?= URL; ?>public/images/certificacion-2.png" alt="IMG" style="width: 90px;">
            </a>
        </div>
    </div>
</div>
            ...
            <div class="col-md-5 p-tb-15">
                <div class="h-full flex-col-m">
                    ...
                    <p class="txt-s-101 cl6">
                        Reciba actualizaciones por correo electrónico sobre nuestras novedades.
                    </p>
                </div>
            </div>
