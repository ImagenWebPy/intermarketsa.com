 <!-- Footer -->
        ...
        <!--===============================================================================================-->
        <script src="<?= URL; ?>public/vendor/countdowntime/moment.min.js"></script>
        <script src="<?= URL; ?>public/vendor/countdowntime/moment-timezone.min.js"></script>
        <script src="<?= URL; ?>public/vendor/countdowntime/moment-timezone-with-data.min.js"></script>
        <script src="<?= URL; ?>public/vendor/countdowntime/jquery.countdown.min.js"></script>
